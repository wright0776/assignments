...
This exercise was to make a timer using Redux. 

It is a React app that uses Redux and React-Redux. 

The app stores the timer value in the redux store as well as the functions to start (increment), stop, and reset the timer. 
