...
In this exercise, I used React.js to create an app that maps through a json file full of superheroes with image urls and catchphrases. The superhero name and image are rendered to the page and then the catchphrase is printed when the respective name or image is clicked. The click function is passed to the child. 
